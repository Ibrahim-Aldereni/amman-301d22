...
// Because in arrow function the (this) value is the same as the enclosing scope (non-arrow function), so because (this) in enclosed with arrow function (this) now will point to the browser window object.
